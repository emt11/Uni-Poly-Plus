...
class UniEncoderAttention(nn.Module):
    def __init__(
        ...
        topology_attention_variant: str = "msta_last2",
        msta_layer_indices=(4, 5),
        msta_local_spd=(0, 1),
        msta_context_spd=(0, 1, 2),
        msta_share_relation_dropout: bool = True,
        msta_local_output_bias: bool = False,
        msta_local_output_init: str = "zero",
        g_family_arm: Optional[str] = None,
        relation_geometry_sidecar: Optional[str] = None,
        g3_permutation_sidecar: Optional[str] = None,
...
class EncoderModule(nn.Module):
    ...
    def _initialize_encoder(
        ...
        use_star_rbf: bool,
        star_rbf_definition: str,
        star_rbf_upper: float,
        use_mcl: bool,
        mcl_mask_mode: str,
        topology_attention_variant: str,
        msta_layer_indices,
        msta_local_spd,
        msta_context_spd,
        msta_share_relation_dropout: bool,
        msta_local_output_bias: bool,
        msta_local_output_init: str,
        g_family_arm: Optional[str],
        relation_geometry_sidecar: Optional[str],
        g3_permutation_sidecar: Optional[str],
        fp_mode: str,
