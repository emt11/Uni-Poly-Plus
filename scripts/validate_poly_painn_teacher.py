...
def main():
    ...
    try:
        ...
        rotation_vector = float((turned["central_vector_states"] - reference["central_vector_states"] @ q_device.T).abs().max())
        rotation_noise = float((turned["predicted_noise"] - reference["predicted_noise"] @ q_device.T).abs().max())
