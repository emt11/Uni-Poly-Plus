#!/usr/bin/env python3
"""Complete the missing Warm0 units for the 8-task x 5-fold ablation."""
...
LOGS = ROOT / "logs/mts_glt_graphgate_v1/fusionwarm_vs_nowarm_20k/eight_task_fold01234"
...
def main(argv=None):
    ...
    command = [
        ...
        "--results-dir", str(ROOT / config["warm0_root"]),
    ...
    return subprocess.call([
        sys.executable,
        "scripts/report_mts_glt_graphgate_fusionwarm_vs_nowarm_20k_8task.py",
    ], cwd=ROOT)
