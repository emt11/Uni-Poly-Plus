...
mkdir -p logs saved_models_starlink_schnet_multistage results
...
nohup python scripts/train.py \
    ...
    --epochs 100 \
    --patience 10 \
    --results_dir ./results/results_starlink_schnet_multistage_all.csv \
    --models_dir ./saved_models_starlink_schnet_multistage \
    > ./logs/train_starlink_schnet_multistage_all.log 2>&1 &

echo "已启动全部任务 star-linking + SchNet 下游训练。日志：./logs/train_starlink_schnet_multistage_all.log"
echo "查看进度：tail -f ./logs/train_starlink_schnet_multistage_all.log"
